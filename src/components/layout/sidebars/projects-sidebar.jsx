...
/**
 * Projects Hub Sidebar Navigation Items
 * Flat list - no collapsible sections
 */
const projectsNavigation = [
  { title: 'Projects', href: '/projects', icon: FolderKanban, description: 'All projects' },
  { title: 'Tasks', href: '/projects/tasks', icon: CheckSquare, description: 'Task management' },
  {
    title: 'Time Tracking',
  ...
  { title: 'Timesheets', href: '/projects/timesheets', icon: Timer, description: 'Time entries' },
  {
    title: 'Team Workload',
 ...
 */
const fixedActions = [
  { id: 'project', title: 'New Project', href: '/projects/new', icon: Plus, variant: 'default' },
  {
    id: 'task',
    title: 'New Task',
...
export function ProjectsSidebar({ onAction }) {
  ...
  const isProjectsPage = pathname === '/projects' || pathname.includes('/projects/list');
  ...
  return (
    <TooltipProvider delayDuration={0}>
      ...
      >
        ...
        {/* Project Filters (shown when on Projects page) */}
        {isProjectsPage && !isCollapsed && (
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-1">
                  {ownerFilters.map((filter) => {
                    const isFilterActive = activeOwnerFilter === filter.id;
                    return (
                      <Button
                        key={filter.id}
                        variant={isFilterActive ? 'secondary' : 'ghost'}
                        ...
                        onClick={() => setActiveOwnerFilter(filter.id)}
                      >
                        {filter.label}
                      </Button>
                    );

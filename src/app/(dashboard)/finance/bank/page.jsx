...
export default function BankPage() {
  ...
  const layoutStats = [
    createStat('Total Balance', '₹26.2L', Wallet, 'blue'),
    createStat('Bank Accounts', '3', Building2, 'green'),
    createStat('Credits Today', '₹3.5L', ArrowDownRight, 'green'),
    createStat('Debits Today', '₹5.7L', ArrowUpRight, 'amber'),
  ];

  return (
    <UnifiedLayout hubId="finance" pageTitle="Bank & Cash" stats={layoutStats} fixedMenu={null}>

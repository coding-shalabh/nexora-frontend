...
export default function PayablesPage() {
  ...
  const layoutStats = [
    createStat('Total Payables', '₹6.0L', ArrowUpRight, 'blue'),
    createStat('Due This Week', '₹1.7L', Clock, 'amber'),
    createStat('Overdue', '₹3.35L', AlertTriangle, 'red'),
    createStat('Paid (Month)', '₹8.5L', CheckCircle, 'green'),
  ];

...
export default function NewTicketPage() {
  ...
  const layoutStats = [
    createStat('New Ticket', '1', Ticket, 'blue'),
    createStat(
      'Priority',
      formData.priority,
      AlertCircle,
      formData.priority === 'URGENT' ? 'red' : 'amber'
    ),
  ];

  return (
    <UnifiedLayout hubId="service" pageTitle="Create Ticket" stats={layoutStats} fixedMenu={null}>

...
export default function KBCategoriesPage() {
  ...
  const layoutStats = [
    createStat('Categories', String(categories.length), FolderOpen, 'blue'),
    createStat('Total Articles', String(totalArticles), FileText, 'green'),
  ];

  return (
    <UnifiedLayout hubId="service" pageTitle="KB Categories" stats={layoutStats} fixedMenu={null}>

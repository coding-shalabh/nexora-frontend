...
export default function EmailConfigPage() {
  ...
  return (
    <UnifiedLayout hubId="settings" pageTitle="Email Configuration" fixedMenu={null}>
      <div className="p-6 space-y-6">
        {/* Header */}
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex gap-4">
                  ...
                  >
                    {testing ? <Loader2 className="h-4 w-4 animate-spin" /> : 'Test Primary'}
                  </Button>
                  <Button
                    variant="outline"
                    ...
                    disabled={testing || !testEmail}
                  >
                    {testing ? <Loader2 className="h-4 w-4 animate-spin" /> : 'Test Support'}
                  </Button>
                </div>
                {testResult && (
                  <div
          ...
          <TabsContent value="signature" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Default signature appended to outgoing emails</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
          ...
          <TabsContent value="tracking" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure tracking options for outgoing emails</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label htmlFor="trackOpens" className="text-base">
                      Track Email Opens
                    </Label>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label htmlFor="trackClicks" className="text-base">
                      Track Link Clicks
                    </Label>
                    <p className="text-sm text-muted-foreground">

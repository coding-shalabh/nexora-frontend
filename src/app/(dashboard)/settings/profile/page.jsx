              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div
                      className={`rounded-lg p-2 ${profile.twoFactorEnabled ? 'bg-green-100' : 'bg-muted'}`}
                    >
                      <Shield
                        className={`h-5 w-5 ${profile.twoFactorEnabled ? 'text-green-600' : 'text-muted-foreground'}`}
                      />
                    </div>
                    <div>
                  ...
                  {profile.twoFactorEnabled ? (
                    ...
                    <Button onClick={() => setShowTwoFactorDialog(true)}>Enable 2FA</Button>
                  )}
                </div>
                ...
                <div className="flex items-center justify-between p-4 rounded-lg border border-primary bg-primary/5">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Mumbai, India • 103.21.45.67</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 rounded-lg border">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Mumbai, India • 103.21.45.90</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
          ...
          <DialogContent className="max-w-md">
            ...
            <div className="space-y-4">
              ...
              <div className="text-center">
                ...
                <code className="text-sm bg-muted px-3 py-2 rounded">ABCD EFGH IJKL MNOP</code>
              </div>
              <div className="space-y-2">
            ...
            <DialogFooter>
              ...
              <Button onClick={() => setShowTwoFactorDialog(false)}>Verify & Enable</Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
      </div>

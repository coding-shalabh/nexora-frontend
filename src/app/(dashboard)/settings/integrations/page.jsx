                ...
                <Card className="border-dashed">
                  <CardContent className="py-12 text-center">
                    ...
                    <p className="text-sm text-muted-foreground/80 mb-4">
                      Connect a provider below to enable SMS, WhatsApp, and other messaging channels
                    </p>
                  </CardContent>
                </Card>
              ) : (
            ...
            {filteredIntegrations.length === 0 && (
              <Card className="border-dashed">
                <CardContent className="py-12 text-center">
                  ...
                  <p className="text-lg font-medium text-muted-foreground">No integrations found</p>

...
const OutlookIcon = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M24 7.387v10.478c0 .23-.08.424-.238.576-.158.154-.352.233-.584.233h-8.501v-6.9l1.66 1.18c.1.063.209.095.329.095.12 0 .229-.032.329-.095l6.767-4.82.015-.012c.088-.058.132-.147.132-.266 0-.224-.133-.336-.399-.336h-.024l-8.809 6.278-8.809-6.278h-.024c-.266 0-.399.112-.399.336 0 .119.044.208.132.266l.015.012 6.767 4.82c.1.063.209.095.329.095.12 0 .229-.032.329-.095l1.66-1.18v6.9H.822c-.232 0-.426-.079-.584-.233-.158-.152-.238-.346-.238-.576V7.387c0-.23.08-.424.238-.576.158-.154.352-.233.584-.233h21.356c.232 0 .426.079.584.233.158.152.238.346.238.576z" fill="#0078D4"/>
  </svg>
)
    ...
    <div className="flex-1 space-y-6 p-6 max-w-4xl">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            <Step number={1} title="Go to Email Settings">
              <p>Navigate to <Link href="/settings/email" className="text-primary hover:underline">Settings → Email</Link> in Nexora.</p>
            </Step>
            ...
            <div className="flex gap-3">
              ...
              <div className="text-sm">
                ...
                <p className="text-blue-800 mt-1">
                  OAuth is the most secure method. We never see or store your Google password.
        ...
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>Yahoo, iCloud, Zoho, GoDaddy, Hostinger, or any IMAP email</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="flex items-center gap-2 text-sm">
            <Badge variant="secondary" className="bg-yellow-100 text-yellow-700">App Password Required</Badge>
            <span className="text-muted-foreground">Some providers need an app-specific password</span>
          </div>

          <div className="space-y-4">
            <Step number={1} title="Generate App Password (if required)">
              <p>Many email providers require an "App Password" instead of your regular password. See the provider-specific guides below.</p>
            </Step>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Step-by-step guides for each email provider
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="yahoo">
              ...
              <AccordionContent className="space-y-4 pl-11">
                <ol className="list-decimal list-inside space-y-2 text-sm">
                  <li>Go to <a href="https://login.yahoo.com/account/security" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Yahoo Account Security <ExternalLink className="inline h-3 w-3" /></a></li>
                ...
                <div className="rounded-lg bg-muted p-3 text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    <code className="bg-background px-2 py-1 rounded">imap.mail.yahoo.com:993</code>
            ...
            <AccordionItem value="icloud">
              ...
              <AccordionContent className="space-y-4 pl-11">
                <ol className="list-decimal list-inside space-y-2 text-sm">
                  <li>Go to <a href="https://appleid.apple.com/account/manage" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Apple ID Settings <ExternalLink className="inline h-3 w-3" /></a></li>
            ...
            <AccordionItem value="zoho">
              ...
              <AccordionContent className="space-y-4 pl-11">
                <ol className="list-decimal list-inside space-y-2 text-sm">
                  <li>Go to <a href="https://accounts.zoho.com/home" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Zoho Account <ExternalLink className="inline h-3 w-3" /></a></li>
            ...
            <AccordionItem value="godaddy">
              ...
              <AccordionContent className="space-y-4 pl-11">
                <p className="text-sm">GoDaddy workspace email uses standard IMAP. Use your regular email password.</p>
                <div className="rounded-lg bg-muted p-3 text-sm">
                  <p className="font-medium mb-1">IMAP Settings:</p>
                  <div className="flex items-center gap-2 mb-2">
                    <code className="bg-background px-2 py-1 rounded">imap.secureserver.net:993</code>
                    <CopyButton text="imap.secureserver.net" />
                  </div>
                  <p className="font-medium mb-1">SMTP Settings:</p>
                  <div className="flex items-center gap-2">
                    <code className="bg-background px-2 py-1 rounded">smtpout.secureserver.net:465</code>
            ...
            <AccordionItem value="hostinger">
              ...
              <AccordionContent className="space-y-4 pl-11">
                <p className="text-sm">Hostinger email uses standard IMAP. Use your regular email password.</p>
                <div className="rounded-lg bg-muted p-3 text-sm">
                  <p className="font-medium mb-1">IMAP Settings:</p>
                  <div className="flex items-center gap-2 mb-2">
                    <code className="bg-background px-2 py-1 rounded">imap.hostinger.com:993</code>
                    <CopyButton text="imap.hostinger.com" />
                  </div>
                  <p className="font-medium mb-1">SMTP Settings:</p>
                  <div className="flex items-center gap-2">
                    <code className="bg-background px-2 py-1 rounded">smtp.hostinger.com:465</code>
            ...
            <AccordionItem value="custom">
              ...
              <AccordionContent className="space-y-4 pl-11">
                <p className="text-sm">For other email providers, you'll need to find the IMAP/SMTP settings from your provider. Common settings:</p>

                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {channels.map((channel) => {
                      ...
                      const badgeColor = channelBadgeColors[channel] || 'bg-gray-50 text-gray-700';
                      return (
                        <span
                          key={channel}
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <DialogDescription className="text-sm text-gray-500">
                  {showEditTeam ? 'Update team details' : 'Create a new team for your organization'}
                </DialogDescription>
              </div>
            </div>
          </DialogHeader>
        ...
        <AlertDialogContent className="rounded-2xl">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-gray-500">
              This will permanently delete the "{selectedTeam?.name}" team. Team members will not be
              deleted but will be removed from this team.
            </AlertDialogDescription>
          </AlertDialogHeader>

...
export default function ExportPage() {
  ...
  const layoutStats = [
    createStat('Fields', selectedFields.length, CheckCircle2, 'blue'),
    createStat('Format', selectedFormat?.label || 'CSV', FileSpreadsheet, 'green'),
  ];

  const layoutActions = [
    createAction('Export Data', Download, handleExport, {
      primary: true,
                ...
                <div className="flex gap-2">
                  ...
                  <div>
                    <p className="text-xs text-blue-900">
                      Export respects your CRM permissions. You'll only export data you have access
                      to.
                    </p>
                  </div>
                </div>

...
export default function MarketingHubPage() {
  const stats = [
    createStat('Total Contacts', '12,847', Users, 'blue'),
    createStat('Email Open Rate', '34.2%', Eye, 'green'),
    createStat('Click Rate', '8.7%', MousePointer, 'purple'),
    createStat('Emails Sent', '45,230', Send, 'orange'),
  ];

  const actions = [
    createAction('New Campaign', Plus, () => {}, {
      primary: true,
      href: '/marketing/campaigns/new',
    }),
  ];

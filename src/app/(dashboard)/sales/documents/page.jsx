...
export default function DocumentsPage() {
  ...
  const stats = [
    createStat('Documents', documentStats.totalDocs, FileText, 'blue'),
    createStat('Views', documentStats.totalViews, Eye, 'green'),
    createStat('Links', documentStats.activeLinks, Link2, 'purple'),
    createStat('Engagement', `${documentStats.avgEngagement}%`, BarChart3, 'orange'),
  ];

  const actions = [
    createAction('Upload', Upload, () => console.log('upload')),
    createAction('Create Link', Plus, () => console.log('create link'), { primary: true }),
  ];

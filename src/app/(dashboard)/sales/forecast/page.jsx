...
export default function ForecastPage() {
  ...
  const stats = [
    createStat('Quota', formatCurrency(forecastData.thisQuarter.quota), Target, 'blue'),
    createStat('Closed Won', formatCurrency(forecastData.thisQuarter.closed), DollarSign, 'green'),
    createStat('Commit', formatCurrency(forecastData.thisQuarter.commit), TrendingUp, 'purple'),
    createStat('Accuracy', `${forecastData.accuracy.lastQuarter}%`, Target, 'orange'),
  ];

  const actions = [createAction('Export', Download, () => console.log('export'))];
                ...
                <div className="grid grid-cols-3 gap-6">
                  <div className="text-center p-4 bg-muted rounded-lg">
                    ...
                    <p className="text-2xl font-bold">
                      {formatCurrency(forecastData.thisQuarter.pipeline)}
                    </p>
                  </div>
                  <div className="text-center p-4 bg-muted rounded-lg">
                    <p className="text-sm text-muted-foreground mb-2">Best Case</p>
                    <p className="text-2xl font-bold text-blue-600">
                      {formatCurrency(forecastData.thisQuarter.bestCase)}
                    </p>
                  </div>
                  <div className="text-center p-4 bg-muted rounded-lg">
                    ...
                    <p className="text-2xl font-bold text-red-600">
                      {formatCurrency(
                        forecastData.thisQuarter.quota - forecastData.thisQuarter.commit
                      )}
                    </p>
                  </div>
                </div>

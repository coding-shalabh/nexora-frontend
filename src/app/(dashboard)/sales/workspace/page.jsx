...
const recentActivities = [
  {
    id: 1,
    type: 'email',
    description: 'Email opened by John Smith',
    time: '5 min ago',
    contact: 'John Smith',
  },
  {
  ...
  },
  {
    id: 4,
    type: 'meeting',
    description: 'Meeting scheduled with Mike Wilson',
    time: '3 hours ago',
    contact: 'Mike Wilson',
  },
  {
    id: 5,
    type: 'note',
    description: 'Note added to Global Industries deal',
    time: '4 hours ago',
...
export default function SalesWorkspacePage() {
  ...
  const stats = [
    createStat('Tasks Today', pendingTasks.length, ListTodo, 'blue'),
    createStat('Calls', performanceMetrics.thisWeek.calls, Phone, 'green'),
    createStat('Meetings', performanceMetrics.thisWeek.meetings, Calendar, 'purple'),
    createStat(
      'Revenue',
  ...
  const actions = [
    createAction('Sync', RefreshCw, () => console.log('sync')),
    createAction('Quick Log', Plus, () => console.log('log'), { primary: true }),
  ];
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between mb-3">
                      <div
                        className={cn(
                          'p-2 rounded-lg',
                          goal.color.replace('text-', 'bg-').replace('500', '100')
                        )}
                      >

...
export default function NewQuotePage() {
  ...
  const [formData, setFormData] = useState({
    ...
    validUntil: '',
    notes: '',
    terms: 'This quote is valid until the date specified above. Payment is due within 30 days of acceptance.',
  });
                ...
                <div className="flex justify-end">
                  <div className="w-80 space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-2xl font-bold text-green-600">{formatCurrency(calculateSubtotal())}</span>
                    </div>
                  </div>
                </div>
              </div>

              ...
              {formData.price && formData.cost && (
                <div className="p-4 bg-muted rounded-lg">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant={parseFloat(margin) > 50 ? 'default' : 'secondary'} className="text-lg">
                      {margin}%
                    </Badge>
                  </div>
                  <p className="text-xs text-muted-foreground mt-1">
                    Profit: ${formData.price && formData.cost ? (parseFloat(formData.price) - parseFloat(formData.cost)).toFixed(2) : '0.00'}
                  </p>
                </div>
              )}
            ...
            <CardContent className="space-y-4">
              ...
              {formData.type === 'recurring' && (
                <div className="space-y-2">
                  ...
                  <Select value={formData.billingPeriod} onValueChange={(value) => handleChange('billingPeriod', value)}>
                    <SelectTrigger>
